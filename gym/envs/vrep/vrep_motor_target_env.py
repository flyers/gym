...
class VREPMotorTargetEnv(VREPBaseEnv):

    def _init_sensor(self):
        super(VREPMotorTargetEnv, self)._init_sensor()
    ...
    def _read_sensor(self):
        super(VREPMotorTargetEnv, self)._read_sensor()
        if self._obs_type == 'image':
    ...
    def __init__(self,
                 scene_path='/home/sliay/Documents/vrep-uav/scenes/quadcopter_motor_64x64.ttt',
                 reward_func=0, log=False,
        ...
        super(VREPMotorTargetEnv, self).__init__(**kwargs)
    ...
    def _reset(self):
        obs = super(VREPMotorTargetEnv, self)._reset()
